        ...
        <div className="section-container">
          ...
          >
            <h1 className="font-heading text-4xl md:text-5xl font-bold text-white mb-4">
              All <span className="text-gradient-gold">Competitions</span>
            </h1>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Browse our live competitions and enter for your chance to win incredible prizes
            </p>
          </motion.div>
        </div>
      </section>
            ...
            <div className="flex gap-4 w-full md:w-auto">
              ...
              <Select value={sortBy} onValueChange={setSortBy}>
                ...
                <SelectContent className="bg-card border-border">
                  ...
                  <SelectItem value="value_high">Prize Value: High to Low</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-xs">
              <span className="text-muted-foreground flex items-center gap-1">
                ...
                {ticketsRemaining.toLocaleString()} left
              </span>
